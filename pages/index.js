...
export default function Home() {
  ...
  return (
    <div className={show_nav? `${styles.container} ${styles.container_cropped}`: `${styles.container}`}>
      <Head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=Secular+One&display=swap"
          rel="stylesheet"
        ></link>
      </Head>

      <div className={show_nav ? styles.show_nav : styles.hide_nav}>
        <Navbar setNav={setNav} show_nav={show_nav} />
      </div>
      ...
      <main className={styles.main}>
        <div className={styles.home_screen}>
          ...
          <section className={styles.intro}>
            ...
            <span>
              <p
                className={styles.intro_p}
              >
                Hi, i&apos;m
              </p>
              <motion.h1 className={styles.intro_h1}>Ugwu Chiagozie Stanley</motion.h1>
